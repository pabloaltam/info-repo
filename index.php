            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        if ($_SESSION['email']) {
                            ?>
                        <h3>Bienvenido <?php echo "$perfil_usuario"; ?></h3>
